...
using Krypton.Toolkit; // Ensure you have the Krypton Toolkit installed for KryptonFontDialog
...
namespace Document_Maker
{
    public partial class DCW : Form
    {
        ...
        {
            KryptonFontDialog fontDialog = new KryptonFontDialog();
        ...
        {
            KryptonColorDialog colorDialog = new KryptonColorDialog();
